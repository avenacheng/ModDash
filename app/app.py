...
# connect to database
try:
    conn = psycopg2.connect(dbname='reddit', user='postgres', password='hello', host='10.0.0.10')
except:
...
if __name__ == '__main__':
    app.run_server(debug=True, port=8050, host='ec2-52-88-201-86.us-west-2.compute.amazonaws.com')
